...
fn part1(input: &str) -> usize {
    input
        ...
        .map(|line| {
            ...
            // println!("{}: {:?},{:?}", line, left_sections, right_sections);
            (left_sections.is_subset(&right_sections) || left_sections.is_superset(&right_sections))
                as usize // bool is guaranteed to be 0 or 1: https://doc.rust-lang.org/std/primitive.bool.html
        })
        .sum()
}
